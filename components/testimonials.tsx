...
const images = [TestimonialImage01, TestimonialImage02, TestimonialImage03];
let delays: number[] = [];
images.forEach((element, index) => {
  delays.push(index * 200);
});
            ...
            {testimonies.map((testimony, index) => (
              ...
              >
                ...
                <div className="text-purple-600 font-medium mt-6 pt-5 border-t border-purple-600">
                  ...
                  -{" "}
                  <a
                    className="text-purple-600 hover:text-purple-200 transition duration-150 ease-in-out"
                    href="#0"
                  >
                    {testimony.role}
                  </a>
